...
<html lang="en">
  <head>
    ...
    <title>Selamat Datang di Aplikasi Presensi Pegawai, SEMANGAT BERKAKTIVITAS</title>
    <!-- CSS files -->
  ...
  <body  class=" d-flex flex-column">
    ...
    <!-- Libs JS -->
    <script src="<?= base_url('assets/libs/apexcharts/dist/apexcharts.min.js?1674944402') ?>" defer></script>
