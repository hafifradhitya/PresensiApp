        ...
        <div class="card col-md-6">
            <div class="card-body">
                <form action="<?= base_url('admin/data_lokasi_presensi/tambah.php') ?>" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="" class="form-label">Alamat Lokasi</label>
                        <input type="text" class="form-control" name="alamat_lokasi" value="<?php if(isset($_POST['alamat_lokasi'])) echo $_POST['nama_lokasi'] ?>">
                    </div>

                    <div class="mb-3">
                        <label for="" class="form-label">Tipe Lokasi</label>
                    ...
                    <div class="mb-3">
                        <label for="" class="form-label">Radius (meter)</label>
