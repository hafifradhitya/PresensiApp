...
if(isset($_POST['submit'])) {
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(empty($role)) {
            $pesan_kesalahan[] = "<i class='fa-solid fa-check'></i> Role masuk wajib diisi";
        }
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label for="" class="form-label">Lokasi Presensi</label>
                            <select name="lokasi_presensi" id="" class="form-control">
                                ...
                                <?php 
                                    ...
                                    while($lokasi = mysqli_fetch_assoc($ambil_lok_presensi)){
                                        ...
                                        if(isset($_POST['lokasi_presensi']) && $_POST['lokasi_presensi'] == $nama_jabatan) {
